...
<title>AgentGuard v0.5 — We Don't Find Bugs. We End Them.</title>
<style>
:root {
...
<aside class="sidebar" id="sidebar">
  <div class="sidebar-header">
    <div class="logo-text">AgentGuard <span>v0.5</span></div>
  </div>
...
<div class="main" id="mainArea">
  <div class="topbar">
    ...
    <div class="title">AgentGuard v0.5</div>
...
function buildHtml(d){
  let h=`<!DOCTYPE html><html><head><meta charset="UTF-8"><title>AgentGuard v0.5 Scan Report</title>`;
  ...
  h+=`<h1>AgentGuard v0.5 Scan Report</h1><p>Path: ${d._path||document.getElementById('path').value}<br>Time: ${new Date().toLocaleString()}<br>Mode: ${mode}</p>`;
...
def serve():
    ...
    print(f"AgentGuard v0.5 Desktop -> {url}")
    try:
